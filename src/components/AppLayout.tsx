...
const navItems: NavItemConfig[] = [
  ...
  { id: "tarefas", label: "Tarefas", icon: <ClipboardList size={18} />, path: "/tarefas", section: "GERAL" },
  { id: "ocorrencias", label: "Ocorrências", icon: <FileText size={18} />, path: "/ocorrencias", section: "GERAL" },
  { id: "documentos", label: "Assinaturas", icon: <FileSignature size={18} />, path: "/documentos", section: "GERAL" },
  { id: "recibos", label: "Recibos", icon: <Receipt size={18} />, path: "/recibos", section: "GERAL" },
  ...
  { id: "simulador", label: "Simulador", icon: <Calculator size={18} />, path: "/pessoal/simulador", section: "DEPARTAMENTOS" },
  ...
  { id: "irpf", label: "IRPF", icon: <Calculator size={18} />, path: "/irpf", section: "CONTROLES" },
