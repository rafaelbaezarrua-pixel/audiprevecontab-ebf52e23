...
interface HonorariosEmpresasViewProps {
  ...
  onUpdateConfigField: (id: string, field: string, value: any) => void;
  onAddOutroServico: (id: string) => void;
  onUpdateOutroServico: (id: string, idx: number, field: string, value: any) => void;
  onRemoveOutroServico: (id: string, idx: number) => void;
  onSaveConfig: (id: string) => void;
  mensalData: Record<string, HonorarioMensal[]>;
  mensalForms: Record<string, any>;
  onUpdateMensalField: (id: string, field: string, value: any) => void;
  onSaveMensal: (id: string) => void;
  onGenerateMonth: (id: string) => void;
  onStartEditMensal: (id: string, record: any) => void;
